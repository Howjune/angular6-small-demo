...
@Component({
  selector: 'app-occupied-parking',
  templateUrl: './occupied-parking.component.html',
  styleUrls: ['./occupied-parking.component.css']
})
export class OccupiedParkingComponent implements OnInit {
  pkLots:PkSpace[];
  getpkLots():void{
